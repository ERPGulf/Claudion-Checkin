  ...
  const handleQRCodeData = async (data) => {
    try {
      ...
      const cleanedData = {
        ...
        app_key: appKey,
        photo: photoFlag,
        restrict_location: qrData["Restrict Location"]?.trim() ?? "0", // 👈 NEW
      };

      console.log("✅ Cleaned QR:", cleanedData);

      // 8️⃣ Validate required fields
      if (
        cleanedData.company &&
        ...
        await AsyncStorage.multiSet([
          ...
          ["restrict_location", cleanedData.restrict_location], // 👈 NEW
        ]);
