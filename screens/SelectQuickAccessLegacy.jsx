...
/**
 * TEMPORARY — the pre-redesign Quick Access picker, kept verbatim so the
 * "Enable Modern UI" toggle can render the old screen. Delete alongside
 * screens/HomeLegacy.jsx when the experiment ends.
 */
function SelectQuickAccessLegacy() {
...
export default SelectQuickAccessLegacy;
